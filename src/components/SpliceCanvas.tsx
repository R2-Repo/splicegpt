    ...
    <div className="canvas-shell">
      ...
      >
        ...
        <Panel position="top-left" className="canvas-debug-panel">
          {liveLayout.cables.length === 0
            ? "No cable nodes parsed"
            : `${liveLayout.cables.length} cable nodes · ${liveRoutes.length} nested routes · ${routes.diagnostics.length} diagnostics`}
        </Panel>
        <ViewportPortal>
          <svg className="route-overlay" width={liveLayout.width} height={liveLayout.height} viewBox={`0 0 ${liveLayout.width} ${liveLayout.height}`}>
            ...
            <text x={liveLayout.centerX} y="38" textAnchor="middle" className="center-label">nested center routing</text>
